...
public:
    ...
    virtual bool write(DRW_Interface *interface_, DRW::Version ver, bool bin);
...
class streamDxfRW : public dxfRW {
    std::vector<uint8_t> *dataBuffer;
public:
    explicit streamDxfRW(std::vector<uint8_t> *buffer);

    bool read(DRW_Interface *interface_, bool ext) override;
